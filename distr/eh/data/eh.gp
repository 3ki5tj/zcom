...
#########################################################################################
# canonical ensemble, basic comparison
...
set logscale y
plot [][1e-6:.5] \
     "dsb_c_ii.dat"     u ($1+binh):($2/1e3) w l lt 4 lc rgb "#C0C0C0" t "histogram", \
     "dsb_c_ii.dat"     u 1:6 w l lt 1 lw 2 lc rgb "#0000ff" t "fractional (this work)", \
     "dsb_c_aj.dat"     u 1:($6 > zcut ? $6 : zcut) w l lt 1 lw 2 lc rgb "#ff0000" t "AJ identity", \
     "ds_c_ix.dat"      u 1:6 w l lt 1 lw 1  t "reference"

#########################################################################################
# canonical ensemble, improving mean force
...
plot [][-0.4:0.5] \
     "dsb_c_ix.dat" u 1:8 w l lt 1 lw 2 lc rgb "#0000ff" notitle, \
     "ds_c_ix.dat" u 1:8 w l lt 1 lw 2 lc rgb "#ff0000" notitle, \
...
set key font keyfont
plot [][1e-6:.2] \
     "dsb_c_ii.dat"     u 1:6 w l lt 1 lw 2 lc rgb "#0000ff" t "fixed window", \
     "dsb_c_ix.dat"     u 1:6 w l lt 1 lw 2 lc rgb "#00ff00" t "variable window", \
     "ds_c_ix.dat"      u 1:6 w l lt 1 lw 1  t "reference"
...
plot [][-1380:-1240] \
     "dsb_c_ix.dat" u 1:11:10 w filledcurves lt 1 lw 0 lc rgb "#00ff00" notitle, \
...
set key font keyfont
plot [][1e-6:.1] \
     "ds_c_ix.dat"      u 1:6 w l lt 1 lw 2 lc rgb "#0000ff" t "canonical", \
     "ds_m_ix.dat"      u 1:6 w l lt 2 lw 2 lc rgb "#ff0000" t "microcanonical"
...
set ylabel "d ln{/Symbol r} / dE" offset 4., 0 font tcfont
plot [][-0.4:0.5] \
     "ds_c_ix.dat" u 1:8 w l lt 1 lw 2 lc rgb "#0000ff" notitle, \
     "ds_m_ix.dat" u 1:8 w l lt 1 lw 2 lc rgb "#ff0000" notitle, \
      0 w l lt 1 lw 1 lc rgb "#000000" notitle
