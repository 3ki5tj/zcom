...
void md_shiftang3d(rv3_t * RESTRICT x, rv3_t * RESTRICT v, int n);
...
real md_ekin(const real *v, int nd, int dof, real * RESTRICT tkin);
...
void md_vscale(real * RESTRICT v, int nd, int dof, real tp, real ekt, real * RESTRICT ekin, real * RESTRICT tkin);
...
void md_vrescale(real * RESTRICT v, int nd, int dof, real tp, real dt, real * RESTRICT ekin, real * RESTRICT tkin);
